...
#PIANO 1#
floor1 = STRUCT([ground0, roof0, solidWall0, solidWall1])
#END#
...
#PIANO 2#
floor2 = STRUCT([ground1, roof1, solidWall2, solidWall3])
#END#
...
#PIANO 3#
floor3 = STRUCT([ground2, roof2, solidWall4, solidWall5])
#END#
...
#PIANO 4#
floor4 = STRUCT([ground3, roof3, solidWall6, solidWall7])
#END#
...
#PIANO 5#
floor5 = STRUCT([ground4, roof4, solidWall8, solidWall9])
#END#
...
#PIANO 6#
floor6 = STRUCT([ground5, roof5, solidWall10, solidWall11])
#END#
...
#PIANO 7#
floor7 = STRUCT([ground6, roof6, solidWall12, solidWall13])
#END#
...
#PIANO 8#
floor8 = STRUCT([ground7, roof7, solidWall14, solidWall15])
#END#
...
#PIANO 9#
floor9 = STRUCT([ground8, roof8, solidWall16, solidWall17])
#END#
...
#PIANO 11#
floor11 = STRUCT([ground10, roof10])
#END#
...
#PIANO 12#
floor12 = STRUCT([ground11, roof11])
#END#
...
#PIANO 13#
floor13 = STRUCT([ground12, roof12])
#END#
...
#PIANO 14#
floor14 = STRUCT([ground13, roof13])
#END#
...
#PIANO 15#
floor15 = STRUCT([ground14, roof14])
#END#
